...
public class AppMain {
  ...
  public static final String ARG_LOGTYPE_REFLECTION = "reflection";
  ...
  public static void main(String[] args) {
    ...
    Debug.log("QBDILA started with args: " + argList + " of length " + argList.size());
    ...
    for (String a : argList) {
      if (a.startsWith(ARG_LOGTYPE)) {
        ...
        } else if (logType.equalsIgnoreCase(ARG_LOGTYPE_REFLECTION)){
          Debug.log("logType is reflection, yep");
          LogLoader.getLogLoader().setLogType(LogLoader.REFLECTION_LOG);          
        } else {
    ...
    if (!argList.contains(ARG_HEADLESS)) {
      Debug.log("Starting Swing UI...");
      SwingUtilities.invokeLater(new Runnable() {
        public void run() {
          MainFrame.initAndShowUI();
        }
      });
    }
